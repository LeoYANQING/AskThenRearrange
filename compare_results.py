...
Usage:
    python -m compare_results \
        --files logs/shard_0.jsonl logs/shard_1.jsonl \
                logs/shard_2.jsonl logs/shard_3.jsonl \
                logs/policy_ablation_10ep.jsonl \
        --modes raw_llm user_preference_first parallel_exploration \
        --output-plot plots/comparison.png
"""
