"""
Simple python interface for local Qwen2.5-7B model.
"""
...
class Qwen2_5_7BAPIError(RuntimeError):
    pass
...
class Qwen2_5_7BAPI:
    ...
    def _post(
        ...
        try:
            ...
            raise Qwen2_5_7BAPIError(f"Request failed: {exc}") from exc

        if response.status_code != 200:
            raise Qwen2_5_7BAPIError(f"API {url} failed: {response.status_code} {response.text}")
