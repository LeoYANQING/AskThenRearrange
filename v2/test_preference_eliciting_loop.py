...
try:
    ...
    from v2.state_update import StateUpdate, update_open_preference_dimensions, update_state_with_answer
    ...
    from state_update import StateUpdate, update_open_preference_dimensions, update_state_with_answer
...
def _state_snapshot(state: AgentState) -> Dict[str, Any]:
    return {
        ...
        "open_preference_dimensions": state["open_preference_dimensions"],
...
def run_preference_eliciting_episode(
    *,
    ...
    state = update_open_preference_dimensions(state=state, updater=updater)
...
def main() -> None:
    ...
    parser.add_argument("--budget-list", type=str, default="1,2,3")
